...
export const metadata: Metadata = {
  ...
  keywords: ['GPR Farms', 'mangoes', 'Banganapalli', 'Himayat', 'carbide-free','farm fresh mangoes', 'tree ripened mangoes'],
  openGraph: {
    title: 'GPR Farms – Premium Farm-Fresh Mangoes',
    description: 'Carbide-free, tree-ripened mangoes direct from our farm. Order online, delivered pan-India.',
  ...
  twitter: {
    ...
    description: 'Tree-ripened, carbide-free mangoes. Farm to your door in 24 hours.',
