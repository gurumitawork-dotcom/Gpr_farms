...
export const metadata: Metadata = {
  ...
  keywords: ['Banganapalli mango', 'Himayat mango', 'Mallika mango', 'Neelam mango', 'Andhra mangoes', 'బంగినపల్లి', 'హిమాయత్'],
  alternates: { canonical: '/varieties' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Mango Varieties – Banganapalli, Mallika, Neelam, Himayat | GPR Farms',
    description: 'Four premium Andhra Pradesh mango varieties, tree-ripened and carbide-free.',
    url: '/varieties',
  ...
  twitter: {
    ...
    description: 'Banganapalli, Mallika, Neelam, Himayat — tree-ripened from Andhra Pradesh.',
  },
};
